...
//       hover: { scale: 1.2, rotate: 30, transition: { duration: 0.3 } }, // Keep the rotate effect
//     };
...
//               <span className="text-sm">Kathmandu, Bagmati Province, Nepal</span>
//             </li>
//             <li className="flex items-center">
//               <FaEnvelope className="h-5 w-5 mr-3 text-indigo-500" />
//               <a
//                 href="mailto:info@studentmanagementsystemsms.com"
...
//         <Link to="/privacy" className="hover:text-indigo-300 ml-4">
//           Privacy Policy
//         </Link>
//         <Link to="/terms" className="hover:text-indigo-300 ml-4">
//           Terms of Service
//         </Link>
//       </motion.div>
//     </motion.footer>
